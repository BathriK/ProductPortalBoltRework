...
import MetricsTabContent from '../components/ProductDetailTabs/MetricsTabContent'; // Import MetricsTabContent
            ...
            <Tabs value={activeTab} className="w-full" onValueChange={setActiveTab}>
              ...
              <TabsContent value="product-metrics" className="tab-content">
                <MetricsTabContent
                  selectedMonth={selectedMonth}
                  selectedYear={selectedYear}
                  metrics={product.metrics} // Pass all metrics, filtering will happen inside MetricsTabContent
                  onMonthYearChange={handleMonthYearChange}
                  isEditMode={false}
                />
              </TabsContent>
